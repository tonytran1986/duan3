...
public class AddDanhMuc extends javax.swing.JFrame {
    ...
    private void loadDanhMuc() {
        ...
        model.setRowCount(0);
        List<DanhMuc> list = addNhanhService.getListDanhMuc();
        for (DanhMuc danhMuc : list) {
            Object rowData[] = {danhMuc.getIdDanhMuc(), danhMuc.getTenDanhMuc()};
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        dm.setTenDanhMuc(txtDanhMuc);
        try {
            addNhanhService.addDanhMuc(dm);
