...
public class ban_Hang extends javax.swing.JFrame {
    ...
    private boolean addHoaDon() {
        ...
        Float tongtien;
        try {
            tongtien = Float.valueOf(tb_gioHang.getValueAt(tb_gioHang.getSelectedRow(), 5) + "");
        } catch (Exception e) {
    ...
    private void initComponents() {
        ...
        jScrollPane2.setBounds(0, 100, 600, 160);
        ...
        btnThemGioHang.setBounds(459, 30, 100, 40);

        jLabel17.setText("Nhập số lượng");
        panelGradiente1.add(jLabel17);
        jLabel17.setBounds(550, 10, 80, 16);
        ...
        panelGradiente1.add(txtSoLuong);
        txtSoLuong.setBounds(560, 30, 70, 40);
        ...
        jScrollPane3.setBounds(0, 30, 600, 160);
        ...
        btn_xoa.setBounds(150, 0, 120, 30);
        ...
        btn_clear.setBounds(300, 0, 130, 30);
        ...
        jScrollPane1.setBounds(0, 30, 600, 150);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(panelGradiente1, javax.swing.GroupLayout.PREFERRED_SIZE, 265, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        ...
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addComponent(panelGradiente4, javax.swing.GroupLayout.DEFAULT_SIZE, 651, Short.MAX_VALUE)
                .addContainerGap())
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
...
//        khbh.setVisible(true);
    ...
    private void btn_taoHoaDonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_taoHoaDonActionPerformed
        if (addHoaDon()) {
            int id = Integer.parseInt(tb_gioHang.getValueAt(tb_gioHang.getSelectedRow(), 0) + "");
            banHangService.deleteGioHang(id + "");
        }
        loadData();
